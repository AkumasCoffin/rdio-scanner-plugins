...
Generated by Rdio Scanner 6.14.1-beta.3. Do not edit — run `rdio-scanner -plugin_docs` to regenerate.
...
Fields: `_id`, `alert`, `autoPopulate`, `blacklists`, `delay`, `id`, `label`, `led`, `led2`, `order`, `talkgroups`, `units`
